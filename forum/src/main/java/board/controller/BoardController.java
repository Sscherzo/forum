...
public class BoardController {
    ...
    public String boardModify(BoardDTO boardDTO,HttpServletRequest request,RedirectAttributes rttr) throws IOException {		
	...
	public String boardModify(Model model,@Valid BoardDTO boardDTO,BindingResult result,HttpServletRequest request,HttpServletResponse response) throws IOException {		
	...
	public String boardDelete(Model model,HttpServletResponse response,
	...
	public String boardLogOut(SessionStatus sessionStatus,HttpServletResponse response) throws IOException {		
