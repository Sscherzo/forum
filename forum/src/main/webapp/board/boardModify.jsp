...
<body>
	<h2>게시글 수정</h2>
	<form action="<%=request.getContextPath()%>/board/temporaryBoardModify"
		...
		<table border="1">
			...
			<tr align="center">
				...
				<td width="150" id="attachments">첨부파일 : <c:if
						test="${boardDTO.original_fileName ne null}">
			...
			<tr>
				<td colspan="4" height="200" valign="top"><textarea
						name="content" rows="12"
						style="width: 98%; border: 0; resize: none;">${boardDTO.content}</textarea>
				</td>
			</tr>
		</table>
