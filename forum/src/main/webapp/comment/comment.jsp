        ...
        <div>
            ...
            <div>
                <table class="table">                    
                    <tr>
                        <td>
                            <textarea style="width: 450px; height: 120px; outline: none; resize: none;" rows="3" cols="30" id="comment_content" name="comment_content" placeholder="댓글을 입력하세요"></textarea>
                            <br>
                            <div>
                                <a href="javascript:;" onClick="fn_comment()" class="btn pull-right btn-success">등록</a>
                            </div>
                        </td>
                    </tr>
                </table>
	                ...
	                for(i=0; i<data.length; i++){           
	                    ...
	                    if(data[i].rno != rno){
		                    ...
		                    html += '<a href="javascript:void(0)" onclick="fn_editReply(' +data[i].rno+ ' )" style="padding-right:5px">수정</a>';
	 	                    ...
	 	                    html +=  data[i].comment_writer;
	 	                    html += "</td>";
	                      	html += "<td width=\"400\" align=\"left\" >"+"<textarea name=\"editContent\" id=\"editContent\" rows=\"10\" style=\"resize: none;\"></textarea>"+"</td>";
	                    	html += "<td align=\"center\">"+data[i].comment_regdate + "</td>";
		                    html += "<td align=\"center\">"
		                    html += '<a href="javascript:void(0)" onclick="fn_ReplyComplete(' +data[i].rno+ ' )" style="padding-right:5px">답변완료</a>';
	                   		html += '<a href="javascript:void(0)" onclick="getCommentList()" >취소</a>';
	                   		html +=	"</td>"
	 	                    html += "</tr>"
	 	                    html += "</table></div>";
